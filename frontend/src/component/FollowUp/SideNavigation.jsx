    ...
    return (
        ...
        <div>
            <ul className='flex md:flex-col md:gap-3 m-auto'>
                <li onClick={() => setselectedValues("Office Visit")} className={`${selectedValues === 'Submit Visit' && 'bg-blue-500 text-white'} rounded-lg py-3 px-2 text-blue-900`}>Submit Visit</li>
